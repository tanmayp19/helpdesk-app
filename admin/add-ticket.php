                ...
                <div class="card-header">Create A Ticket</div>
                  <div class="card-body">
                      ...
                      <form method="post" action="../db/add-ticket.php">
                        ...
                        <button type="submit" class="btn btn-primary btn-block" name="submit">Create Ticket</button>
