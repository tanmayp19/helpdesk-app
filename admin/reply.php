          ...
          <div class="card w-50 card-register mx-auto mt-3"> 
                <div class="card-header">REPLY</div>
                  <div class="card-body">
                      ...
                      <form method="post" action="../db/mail.php?id=<?php echo $id; ?>">
                        ...
                        <div class="form-group">
                          <div class="form-row">
                            <div class="col-md-12">
                              ...
                              <textarea class="form-control" type="textarea" id="message" name="txtarea" maxlength="140" rows="7" readonly><?= $person->Message; ?></textarea>
                        ...
                        <div class="form-group">
                          <div class="form-row">
                            <div class="col-md-12">
                              ...
                              <textarea class="form-control" type="textarea" id="message" name="reply" value="" maxlength="500" rows="7"></textarea>
                              <span class="help-block"><p id="characterLeft" class="help-block ">You have reached the limit</p></span> 
                            </div>
                        </div>


                        <button type="submit" class="btn btn-primary btn-block" name="submit">REPLY</button>
